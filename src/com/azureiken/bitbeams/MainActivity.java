...
//	private Folder folderList;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (!mboolean) {
			...
			try{
	        	InputStream properties = getResources().openRawResource(R.raw.development);
...
//        setupSearchView();
		list.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				System.out.println(list.getAdapter().getCount());
				...
				try {
					if ((int) id == 0){
						...
						bundel.putString("path", "Documents");
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		try {
			...
			case R.id.boxLogin:
				myClass = Class.forName("com.azureiken.boxcloudstorage.BoxLoginActivity");
				break;
			case R.id.search:
